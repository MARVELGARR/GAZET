...
import Sliders from '@/components/formComponents/Sliders';
...
const Forms = () => {
  ...
  return (
    <div className='block md:flex w-full'>
      ...
      <div className='mb-5 flex w-[90%] md:w-[55%] justify-end gap-10'><p className='text-slate-400'>Already have an account?</p>
      ...
      <h1 className='text-extrabold text-3xl text-left'>Welcome to Gazet!</h1>
      <p className='text-slate-400 mb-10 text-bold text-left'>Register your account</p>
      </div>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2 w-[90%] md:w-[55%]">
            <FormField
